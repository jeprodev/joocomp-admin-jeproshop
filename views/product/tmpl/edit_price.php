            ...
            <div class="panel-content" >
                ...
                <div class="control-group">
                    <div class="control-label">
                        ...
                        <label for="jform_wholesale_price" title="<?php echo JText::_('COM_JEPROSHOP_PRODUCT_PRE_TAX_WHOLE_SALE_PRICE_TITLE_DESC'); ?>" >
                            <?php if(!$this->context->country->display_tax_label || $this->tax_exclude_tax_option){
                                echo JText::_('COM_JEPROSHOP_PRODUCT_WHOLESALE_PRICE_LABEL'); }else{ echo JText::_('COM_JEPROSHOP_PRODUCT_PRE_TAX_WHOLE_SALE_PRICE_LABEL'); } ?>
                        </label>
                    </div>
                    <div class="controls">
                        <div class="input-append" >
                            <?php if($this->currency->prefix != ""){ ?><button type="button" class="btn"  ><?php echo $this->currency->prefix; ?></button><?php } ?>
                            <input type="text" maxlength="14" name="price_field[wholesale_price]" id="jform_wholesale_price"
                                   value="<?php echo JeproshopTools::convertPrice($this->product->wholesale_price); ?>"  class="price-box" />
                ...
                <div class="control-group">
                    <div class="control-label">
                        ...
                        <label for="jform_price_tax_excluded" title="<?php echo JText::_('COM_JEPROSHOP_PRODUCT_PRE_TAX_RETAIL_PRICE_TITLE_DESC'); ?>" >
                            <?php if(!$this->context->country->display_tax_label || $this->tax_exclude_tax_option){
                                echo JText::_('COM_JEPROSHOP_PRODUCT_RETAIL_PRICE_LABEL');
                            }else{ echo JText::_('COM_JEPROSHOP_PRODUCT_PRE_TAX_RETAIL_PRICE_LABEL'); } ?>
                        </label>
                    </div>
                    <div class="controls">
                        <input type="hidden" id="jform_real_price_tax_excluded" name="price_field[price]" value="" class="price-box"/>
                        <div class="input-append" >
                            <?php if($this->currency->prefix != ""){ ?><button type="button" class="btn"  ><?php echo $this->currency->prefix; ?></button><?php } ?>
                            <input type="text" maxlength="14" id="jform_price_tax_excluded" name="price_field[price_displayed]" value="<?php echo JeproshopTools::convertPrice($this->product->price); ?>" class="price-box" />
                            <?php if($this->currency->suffix != ""){ ?><button type="button" class="btn" ><?php echo $this->currency->suffix; ?></button><?php } ?>
                        </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <span  >
                            ...
                            <a class="button btn confirm-leave" href="<?php echo JRoute::_('index.php?option=com_jeproshop&view=tax&task=add_rules_group&product_id=' . $this->product->product_id . '&' . JeproshopTools::getTaxToken() . '=1'); ?>" >
                ...
                <div class="control-group" <?php if(!$this->context->country->country_display_tax_label || $this->tax_exclude_tax_option){ ?> style="display:none;" <?php } ?> >
                    <div class="control-label">
                        <label for="jform_price_tax_included" title="<?php echo JText::_('COM_JEPROSHOP_PRODUCT_RETAIL_PRICE_WITH_TAX_TITLE_DESC'); ?>" >
                            <?php echo JText::_('COM_JEPROSHOP_PRODUCT_RETAIL_PRICE_WITH_TAX_LABEL'); ?>
                        </label>
                    </div>
                    <div class="controls">
                        <div class="input-append" >
                            <?php if($this->currency->prefix != ""){ ?><button type="button" class="btn" ><?php echo $this->currency->prefix; ?></button><?php } ?>
                            <input size="11" maxlength="14" id="jform_price_tax_included" type="text" value="<?php echo JeproshopTools::convertPrice($this->product->price); ?>"   class="price-box" />
                            <?php if($this->currency->suffix != ""){ ?><button type="button" class="btn" ><?php echo $this->currency->suffix; ?></button><?php } ?>
                        </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php echo JText::_('COM_JEPROSHOP_PER_LABEL'); ?>&nbsp;&nbsp;
                        <input id="jform_unity" name="price_field[unity]" type="text" value="<?php echo htmlentities($this->product->unity); ?>"  class="unit-box" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <p class="checkbox"  >
                            <input type="checkbox" name="price_field[on_sale]" id="jform_on_sale" style="padding-top: 5px;" <?php if($this->product->on_sale){ ?>checked="checked" <?php } ?> value="1" />
                            <label for="jform_on_sale" class="t" style="font-weight: bold; "><?php echo JText::_('COM_JEPROSHOP_PRODUCT_DISPLAY_ON_SALE_ICON_MESSAGE'); ?></label>
                        </p>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <span <?php if(!$this->use_tax){ ?> style="display:none; " <?php } ?> >
                            ...
                            <?php echo $this->context->currency->prefix . " "; ?><span id="jform_final_price_without_tax" ></span>
                            <?php echo  ' ' . $this->context->currency->suffix; if( $this->context->country->display_tax_label){ echo ' (' . JText::_('COM_JEPROSHOP_TAX_EXCLUDED_LABEL') . ')'; } ?>
                        </span>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls" >
                        ...
                        <button type="button" name="save_price" class="btn btn-default pull-right"  id="jform_save_price" ><i class="process-icon-save"></i> <?php echo JText::_('COM_JEPROSHOP_SAVE_AND_STAY_LABEL'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="panel" >
            ...
            <div class="panel-content " >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" >
                        <br /><a class="button btn btn-icon" href="#" id="jform_show_specific_price"  ><i class="add-icon" ></i> <span><?php echo JText::_('COM_JEPROSHOP_ADD_NEW_SPECIFIC_PRICE_LABEL'); ?></span></a>
                        <a class="button btn btn-icon" href="#" id="jform_hide_specific_price" style="display:none" ><i class="cross-icon" ></i> <span><?php echo JText::_('COM_JEPROSHOP_CANCEL_NEW_SPECIFIC_PRICE_LABEL'); ?></span></a>
                        <br/>
                    </div>
                </div>
                <div id="jform_add_specific_price_form" style="display:none;" >
                    <div class="control-group" >
                        ...
                        <div class="controls margin-form" >
                            <?php if(!$this->multi_shop){ ?>
                                <input type="hidden" name="price_field[specific_price_shop_id]" value="0" />
                            <?php }else{ ?>
                                <select name="price_field[specific_price_shop_id]" id="jform_specific_price_shop_id" class="middle-size" >
                            ...
                            <?php } ?>
                            <select name="price_field[specific_price_currency_id]" id="jform_specific_price_currency_0" class="middle-size" >
                            ...
                            <select name="price_field[specific_price_country_id]" id="jform_specific_price_country_id" class="middle-size" >
                            ...
                            <select name="price_field[specific_price_group_id]" id="jform_specific_price_group_id" class="middle-size" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="hidden" name="price_field[specific_price_customer_id]" id="jform_specific_price_customer_id" value="0" />
                            ...
                            <i class="loading-icon"  id="jform_customer_loader" style="display: nne;" ></i>
                    ...
                    <?php if(count($this->combinations) != 0) { ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="jform_specific_price_product_attribute_id" name="price_field[specific_price_product_attribute_id]" >
                    ...
                    <?php }?>
                    <div class="control-group">
                        <div class="control-label"><label for="jform_specific_price_from" title="<?php echo JText::_('COM_JEPROSHOP_SPECIFIC_PRICE_AVAILABLE_FROM_TITLE_DESC'); ?>"><?php echo JText::_('COM_JEPROSHOP_SPECIFIC_PRICE_AVAILABLE_FROM_LABEL') ; ?></label></div>
                        <div class="controls">
                            <input class="datepicker input-date" type="text" name="price_field[specific_price_from]" value=""  id="jform_specific_price_from"  />
                            <span style="font-weight:bold; color:#000000; font-size:12px; padding: 5px;"><?php echo " ". JText::_('COM_JEPROSHOP_TO_LABEL') . " "; ?></span>
                            <input class="datepicker input-date" type="text" name="price_field[specific_price_to]" value="" id="jform_specific_price_to" />
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="control-label"><label for="jform_specific_price_from_quantity" ><?php echo JText::_('COM_JEPROSHOP_STARTING_AT_LABEL'); ?></label></div>
                        <div class="controls">
                            <input type="text" name="price_field[specific_price_from_quantity]" id="jform_specific_price_from_quantity" value="1" size="3" class="quantity-box"/>
                            <span style="font-weight:bold; color:#000000; font-size:12px"><?php echo JText::_('COM_JEPROSHOP_UNIT_LABEL'); ?></span>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="control-label">
                            <label for="jform_specific_price_price">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="price_field[specific_price_reduction]" id="jform_specific_price_reduction" value="0.00" class="price-box" />&nbsp;
                            <select name="price_field[specific_price_reduction_type]" id="jform_specific_price_reduction_type" class="medium-select" >
                            ...
                            <p class="small"><?php echo JText::_('COM_JEPROSHOP_DISCOUNT_APPLIED_AFTER_TAX_MESSAGE'); ?></p>
                        </div>
                    </div>
                    <div class="control-group" >
                        <div class="controls" >
                            <a class="btn btn-default"  href="<?php echo JRoute::_('index.php?option=com_jeproshop&view=product'); ?>"  ><?php echo JText::_('COM_JEPROSHOP_CANCEL_LABEL'); ?></a>
                            <button type="button" class="btn btn-default pull-right" id="jform_save_specific_price" ><?php echo JText::_('COM_JEPROSHOP_SAVE_AND_STAY_LABEL'); ?></button>
                        </div>
                    </div>
                </div>
                            ...
                            <?php }else{
                                ...
                                foreach ($this->specific_prices as $specificPrice){
                                    ...
                                    if ($specificPrice->product_attribute_id){
                                        ...
                                        $attributesName = JText::_('COM_JEPROSHOP_ALL_COMBINATIONS_LABEL');
                                    }

                                    $rule = new JeproshopSpecificPriceRuleModelSpecificPriceRule((int)$specificPrice->specific_price_rule_id);
                                    $ruleName = ($rule->specific_price_rule_id ? $rule->name : '--');
                                    ...
                                    if (!$specificPrice->shop_id || in_array($specificPrice->shop_id, JeproshopShopModelShop::getContextListShopIds())){
                                ?>
                            <tr class="row_<?php echo ($i % 2 ? '0' : '1'); ?>">
                                <td><?php echo  $ruleName; ?></td>
                                <td><?php echo $attributesName; ?></td>
                                <?php $canDeleteSpecificPrices = true;
                                        if (JeproshopShopModelShop::isFeaturePublished()){
                                            $specificPriceShopId = $specificPrice->shop_id;
                                            $canDeleteSpecificPrices = (count($this->context->employee->getAssociatedShops()) > 1 && !$specificPriceShopId) || $specificPriceShopId;
                                ?>
                                <td><?php echo ($specificPriceShopId ? $this->shops[$specificPriceShopId]['name'] : JText::_('COM_JEPROSHOP_ALL_SHOPS_LABEL')); ?></td>
                                        <?php }
                                $price = JeproshopTools::roundPrice($specificPrice->price, 2);
                                $fixedPrice = ($price == JeproshopTools::roundPrice($this->product->price, 2) || $specificPrice->price == -1) ? '--' : JeproshopTools::displayPrice($price, $currentSpecificCurrency);
                                ?>
                                ...
                                <td title="<?php echo  JText::_('COM_JEPROSHOP_ID_LABEL') . ' '.$specificPrice->customer_id; ?>"><?php echo (isset($customerFullName) ? $customerFullName : JText::_('COM_JEPROSHOP_ALL_CUSTOMERS_LABEL')); ?></td>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-content" >
                            ...
                            <div class="input-group center" >
                                ...
                                <select id="jform_specific_price_priority_1" name="price_field[specific_price_priority_1]" class="middle-size" >
                                    <option value="shop_id" <?php if($specificPricePriorities[0] == 'shop_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_SHOP_LABEL'); ?></option>
                                    <option value="currency_id" <?php if($specificPricePriorities[0] == 'currency_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_CURRENCY_LABEL'); ?></option>
                                    <option value="country_id" <?php if($specificPricePriorities[0] == 'country_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_COUNTRY_LABEL'); ?></option>
                                    <option value="group_id" <?php if($specificPricePriorities[0] == 'group_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_GROUP_LABEL'); ?></option>
                                </select>
                                <?php } if(isset($specificPricePriorities[1])){ ?>
                                &nbsp;<span class="input-group-addon"><i class="icon-chevron-right"></i></span>&nbsp;
                                <select id="jform_specific_price_priority_2" name="price_field[specific_price_priority_2]" class="middle-size" >
                                    <option value="shop_id" <?php if($specificPricePriorities[1] == 'shop_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_SHOP_LABEL'); ?></option>
                                    <option value="currency_id" <?php if($specificPricePriorities[1] == 'currency_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_CURRENCY_LABEL'); ?></option>
                                    <option value="country_id" <?php if($specificPricePriorities[1] == 'country_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_COUNTRY_LABEL'); ?></option>
                                    <option value="group_id" <?php if($specificPricePriorities[1] == 'group_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_GROUP_LABEL'); ?></option>
                                </select>
                                <?php } if(isset($specificPricePriorities[2])){ ?>
                                &nbsp;<span class="input-group-addon"><i class="icon-chevron-right"></i></span>&nbsp;
                                <select id="jform_specific_price_priority_3" name="price_field[specific_price_priority_3]" class="middle-size" >
                                    <option value="shop_id" <?php if($specificPricePriorities[2] == 'shop_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_SHOP_LABEL'); ?></option>
                                    <option value="currency_id" <?php if($specificPricePriorities[2] == 'currency_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_CURRENCY_LABEL'); ?></option>
                                    <option value="country_id" <?php if($specificPricePriorities[2] == 'country_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_COUNTRY_LABEL'); ?></option>
                                    <option value="group_id" <?php if($specificPricePriorities[2] == 'group_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_GROUP_LABEL'); ?></option>
                                </select>
                                <?php } if(isset($specificPricePriorities[3])){ ?>
                                &nbsp;<span class="input-group-addon"><i class="icon-chevron-right"></i></span>&nbsp;
                                <select id="jform_specific_price_priority_4" name="price_field[specific_price_priority_4]" class="middle-size" >
                                    <option value="shop_id" <?php if($specificPricePriorities[3] == 'shop_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_SHOP_LABEL'); ?></option>
                                    <option value="currency_id" <?php if($specificPricePriorities[3] == 'currency_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_CURRENCY_LABEL'); ?></option>
                                    <option value="country_id" <?php if($specificPricePriorities[3] == 'country_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_COUNTRY_LABEL'); ?></option>
                                    <option value="group_id" <?php if($specificPricePriorities[3] == 'group_id'){ ?>  selected="selected" <?php } ?> ><?php echo JText::_('COM_JEPROSHOP_GROUP_LABEL'); ?></option>
                                </select>
                                <?php } ?>
                            </div>
                        </div>
