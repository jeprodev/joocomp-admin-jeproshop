...
require_once $modelsPath . 'cart_rule.php';
...
require_once $modelsPath . 'customization.php';;
...
require_once $modelsPath . 'product_warehouse.php';
...
require_once $modelsPath . 'referrer.php';
